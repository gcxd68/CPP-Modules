...
/*   Updated: 2025/11/11 14:50:08 by gdosch           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	std::cout << std::endl << MAGENTA << "=== TEST 2: Array of Animals ===" << RESET << std::endl;
	{
		...
		for (size_t i = 0; i < size; i++) {
			std::cout << "[ Creating AAnimal No." << i + 1 << " = ";
			if (i < size / 2) {
	...
	// std::cout << std::endl << MAGENTA << "=== TEST 5: Proof that AAnimal is abstract ===" << RESET << std::endl;
